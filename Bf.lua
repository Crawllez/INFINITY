...
local StarServer = Star:Server("infinity hub",8521503225)
...
function checklevel()
   ...
   elseif newworld then
	...
	wait(3)
	local win = Nill:Window("")



	local serv = win:Server("Infinity hub", "")
   ...
   AutoFram:Toggle("Bring mob",_G.Magnet,function(vu)
	...
	AutoFram:Toggle("Auto Farm",_G.FARM,function(vu)
